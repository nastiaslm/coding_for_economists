...
# How many characters does your string have?
print('Our string a has ⎨len(a)⎬ characters')
...
# Check if True and 1 are in face equivalent 
print(True == 1)
...
# Testing for less than/more than or equal to
print(2 <= 3) #True
print(2 >= 3) #False
