...
# Defaul values for function arguments 
...
def castlistitems_to_str(list_of_objects):
  """
...
# print(castlistitems_to_str([1, '3', 3, 5]))

# print(help(castlistitems_to_str))
